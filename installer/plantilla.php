...
config::setDbDriver('$driver'); // pgsql mysql
config::setDbName('$dbName');
config::setDbPort($port); // 5432 3306
...
config::setCookieTime(3600 * $CookieTime); // una hora en segundo 3600 y por 8 serían 8 horas

        ...
        <section>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-group"> <!--filtro para llamar foranea-->
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="filterTrabajador" name="filter[Employee]">
            ...
            <form id="frmDeleteAll" action="<?php echo routing::getInstance()->getUrlWeb('salida_bodega', 'deleteSelect') ?>" method="POST">
                <div>
                    ...
                    <a class="btn btn-default btn-xs" href="<?php echo routing::getInstance()->getUrlWeb('salida_bodega', 'deleteFilters')?>" ><?php echo i18n::__('delete')." ";echo i18n::__('filters')?></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn btn-group btn-xs">
                                        ...
                                        <a href="<?php echo routing::getInstance()->getUrlWeb('detalle_salida', 'view', array(salidaBodegaTableClass::ID => $salida_bodega->$id)) ?>" class="btn btn-info btn-xs"><?php echo i18n::__('detail') ?></a>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <div class="modal fade" id="myModalDelete<?php echo $salida_bodega->$id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <?php // echo i18n::__('Do you want to delete the record?') ?> <?php // echo $repote_parto->$n_trabajadores_vi ?> 
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo i18n::__('close') ?></button>

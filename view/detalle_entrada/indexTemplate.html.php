...
<div class="container container-fluid">
    <div class="page page-header text-center">
        <h1><i class="fa fa-truck"><?php echo i18n::__('entry_detail') ?></i></h1>
    </div>
    <div class="row">
        <header>
        ...
        <section>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn btn-group btn-xs">
                                       ...
                                       <?php if(session::getInstance()->hasCredential('admin')) : ?>
                                        <a href="<?php echo routing::getInstance()->getUrlWeb('detalle_entrada','edit', array(detalleEntradaTableClass::ID => $detalle_entrada->$id)) ?>" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-edit"></i></a>
            ...
            <div>
                Pagina<select id="sqlPaginador" onchange="paginador(this,'<?php echo routing::getInstance()->getUrlWeb('detalle_entrada', 'index')?>')">

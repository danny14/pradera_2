...
<form method="POST" action="<?php echo routing::getInstance()->getUrlWeb('animal', ((isset($objAnimal)) ? 'update' : 'create' ))?>">
   ...
   <input class="form-control" type="text" value="<?php echo ((isset($objAnimal)) ? $objAnimal[0]->$nombre : ((isset($animal[$nombre]))? $animal[$nombre] : '') ) ?>" name="<?php echo animalTableClass::getNameField(animalTableClass::NOMBRE, true )?>">
   <?php if (isset($animal[$nombre])): ?><span class="glyphicon glyphicon-remove form-control-feedback" aria-hidden="true"></span><?php endif ?>
    ...
    <input class="form-control" type="text" value="<?php echo ((isset($objAnimal)) ? $objAnimal[0]->$genero : ((isset($animal[$genero])) ? $animal[$genero] : '') ) ?>" name="<?php echo animalTableClass::getNameField(animalTableClass::GENERO, true )?>">
    ...
    <input class="form-control" type="text" value="<?php echo ((isset($objAnimal)) ? $objAnimal[0]->$edad : ((isset($animal[$edad]))? $animal[$edad] : '' ) ) ?>" name="<?php echo animalTableClass::getNameField(animalTableClass::EDAD, true )?>">
   ...
   <input class="form-control" type="text" value="<?php echo ((isset($objAnimal)) ? $objAnimal[0]->$peso : ((isset($animal[$peso])) ? $animal[$peso] : '') ) ?>" name="<?php echo animalTableClass::getNameField(animalTableClass::PESO, true )?>">
   ...
   <input class="form-control" type="date" value="<?php echo ((isset($objAnimal)) ? $objAnimal[0]->$fecha_ingreso : ((isset($animal[$fecha_parto]))? $animal[$fecha_parto] : '' ) ) ?>" name="<?php echo animalTableClass::getNameField(animalTableClass::FECHA_INGRESO, true )?>">
   ...
   <input class="form-control" type="text" value="<?php echo ((isset($objAnimal)) ? $objAnimal[0]->$numero_partos : ((isset($animal[$numero_partos]))? $animal[$numero_partos] : '') ) ?>" name="<?php echo animalTableClass::getNameField(animalTableClass::NUMERO_PARTOS, true )?>">

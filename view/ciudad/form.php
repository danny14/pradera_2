...
<form method="POST" action="<?php echo routing::getInstance()->getUrlWeb('ciudad', ((isset($objRaza)) ? 'update' : 'create' ))?>">
    <?php if (isset($objRaza)== true):?>
    <input name="<?php echo ciudadTableClass::getNameField(ciudadTableClass::ID,TRUE)?>" value="<?php echo $objRaza[0]->$id ?>" type="hidden">
    <?php endif ?>
   ...
   <input class="form-control" type="text" value="<?php echo ((isset($objRaza)) ? $objRaza[0]->$descripcion : '' ) ?>" name="<?php echo ciudadTableClass::getNameField(ciudadTableClass::DESCRIPCION, true )?>">

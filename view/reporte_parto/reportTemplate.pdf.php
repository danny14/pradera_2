...
$pdf->Cell(215,10,'REPORTE PARTO',1,1,'C');




  $pdf->Cell(20,10,  utf8_decode("ID"),1);
  $pdf->Cell(45,10,  utf8_decode("FECHA_PARTO "),1);
  ...
  $pdf->Cell(40,10,  utf8_decode("OBSERVACIONES"),1);
  
  $pdf->Ln();
foreach ($objReporteParto as $reporteParto){
  
  $pdf->Cell(20,10,  utf8_decode($reporteParto->id),1);
  $pdf->Cell(45,10,  utf8_decode($reporteParto->fecha_parto),1);
  ...
  $pdf->Cell(40,10,  utf8_decode($reporteParto->observaciones),1);

...
<div class="container container-fluid">
    ...
    <div class="row">
        ...
        <!-- Ventana Modal para los Filtros -->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" class="form-horizontal" id="filterForm" action="<?php echo routing::getInstance()->getUrlWeb('estado', 'index')?>">
                        ...
                        <div class="modal fade" id="myModalDelete<?php echo $estado->$id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <?php echo i18n::__('Do you want to delete the record?') ?> <?php echo $estado->$descripcion ?> 
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo i18n::__('close') ?></button>
                                        <button type="button" class="btn btn-danger" onclick="eliminar(<?php echo $estado->$id ?>, '<?php echo estadoTableClass::getNameField(estadoTableClass::ID, TRUE) ?>', '<?php echo routing::getInstance()->getUrlWeb('estado', 'delete') ?>','<?php echo routing::getInstance()->getUrlWeb('estado', 'index')?>')"><?php echo i18n::__('confirm') ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div>
                Pagina<select id="sqlPaginador" onchange="paginador(this,'<?php echo routing::getInstance()->getUrlWeb('estado', 'index')?>')">
...
<!------------------------------------->
<!-----------------Ventana Modal de Error Foranea----------------------->

...
$pdf->Cell(215,10,'PAGO TRABAJADORES',1,1,'C');




  $pdf->Cell(20,10,  utf8_decode("ID"),1);
  $pdf->Cell(45,10,  utf8_decode("FECHA_INICIO "),1);
  $pdf->Cell(30,10,  utf8_decode("FECHA_FIN"),1);
  $pdf->Cell(30,10,  utf8_decode("SUBTOTAL"),1);
  $pdf->Cell(30,10,  utf8_decode("VALOR_HORA"),1);
  $pdf->Cell(30,10,  utf8_decode("ID_TRABAJADOR"),1);
  $pdf->Cell(30,10,  utf8_decode("HORAS_EXTRAS"),1);
...
foreach ($objPagoTrabajadores as $pagoTrabajadores){
  ...
  $pdf->Cell(45,10,  utf8_decode($pagoTrabajadores->fecha_inicio),1);
  ...
  $pdf->Cell(30,10,  utf8_decode($pagoTrabajadores->horas_extras),1);
  $pdf->Cell(30,10,  utf8_decode($pagoTrabajadores->horas_extras),1);

    ...
    <div class="row">
      ...
      <section>
        ...
        <form id="frmDeleteAll" action="<?php echo routing::getInstance()->getUrlWeb('detalle_salida', 'deleteSelect') ?>" method="POST">
          <div>
            <a href="<?php echo routing::getInstance()->getUrlWeb('detalle_salida', 'insert', array(salidaBodegaTableClass::ID => $salida_bodega->id)) ?>" class="btn btn-success btn-xs"><?php echo i18n::__('new') ?></a>
           ...
           <!-- <a class="btn btn-default btn-xs" href="<?php // echo routing::getInstance()->getUrlWeb('detalle_salida', 'deleteFilters')  ?>" ><?php
            // echo i18n::__('delete') . " ";
//        echo i18n::__('filters') 
            ?></a>-->
...
<?php foreach ($objDetalleSalida as $detalle_salida): ?>
  ...
  <!--                 <a href="<?php echo routing::getInstance()->getUrlWeb('detalle_salida', 'view', array(detalleSalidaTableClass::ID => $detalle_salida->$id_salida_bodega)) ?>" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-eye-open"></i></a>-->
                      <a href="<?php echo routing::getInstance()->getUrlWeb('detalle_salida', 'edit', array(detalleSalidaTableClass::ID => $detalle_salida->$id, detalleSalidaTableClass::ID_SALIDA_BODEGA => $detalle_salida->$id_salida_bodega)) ?>" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-edit"></i></a>
...
<?php endforeach; ?> 
        ...
        <div>
          Pagina<select id="sqlPaginador" onchange="paginador(this, '<?php echo routing::getInstance()->getUrlWeb('detalle_salida', 'view') ?>')">

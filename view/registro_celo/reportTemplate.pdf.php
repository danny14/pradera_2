...
$edad_animal = registroCeloTableClass::EDAD_ANIMAL;
...
$pdf->Cell(215,10,'REGISTRO CELO',1,1,'C');
  ...
  $pdf->Cell(45,10,  utf8_decode("EDAD ANIMAL"),1);
...
foreach ($objRegistroCelo as $registrocelo){
  $pdf->Cell(40,10,  utf8_decode($registrocelo->$id),1);
  $pdf->Cell(45,10,  utf8_decode($registrocelo->$edad_animal),1);
  $pdf->Cell(40,10,  utf8_decode($registrocelo->$fecha),1);

...
<div class="container container-fluid">
    ...
    <div class="row">
        ...
        <!-- Ventana Modal para los Filtros -->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" class="form-horizontal" id="filterForm" action="<?php echo routing::getInstance()->getUrlWeb('tipo_insumo', 'index')?>">
            ...
            <form id="frmDeleteAll" action="<?php echo routing::getInstance()->getUrlWeb('tipo_insumo', 'deleteSelect') ?>" method="POST">
                <div class="botones">
                <a href="<?php echo routing::getInstance()->getUrlWeb('tipo_insumo', 'insert')?>" class="btn btn-success btn-xs">Nuevo</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn btn-group btn-xs">
                                <a href="<?php echo routing::getInstance()->getUrlWeb('tipo_insumo', 'view',array(tipoInsumoTableClass::ID => $tipo_insumo->$id))?>" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-eye-open"><?php?></i></a>
                                <a href="<?php echo routing::getInstance()->getUrlWeb('tipo_insumo', 'edit', array(tipoInsumoTableClass::ID => $tipo_insumo->$id));?>" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-edit"></i></a>
                                <a data-toggle="modal" data-target="#myModalDelete<?php echo $tipo_insumo->$id ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                            </div>
                        </td>
                    </tr>
                    <!--Ventana MODAL ELIMINAR SIMPLE-->
                        <div class="modal fade" id="myModalDelete<?php echo $tipo_insumo->$id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    ...
                                    <div class="modal-body">
                                        <?php echo i18n::__('Do you want to delete the record?') ?> <?php echo $tipo_insumo->$descripcion ?> 
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo i18n::__('close') ?></button>
            ...
            <div>
                Pagina<select id="sqlPaginador" onchange="paginador(this,'<?php echo routing::getInstance()->getUrlWeb('tipo_insumo', 'index')?>')">

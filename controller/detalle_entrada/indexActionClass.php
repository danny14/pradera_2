...
//                }
            ...
            $this->objDetalleEntrada = detalleEntradaTableClass::getAll($fields, FALSE ,$orderBy,'ASC', config::getRowGrid(),$page,$where);
...
//        if($id_estado === '' or $id_raza === NULL){}
        ...
        if($flag === TRUE){
            ...
            session::getInstance()->setFlash('modalFilter', true);
            routing::getInstance()->forward('detalle_entrada', 'index');
        }
    }
}

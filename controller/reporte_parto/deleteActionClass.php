  ...
  public function execute() {
    try {
      if (request::getInstance()->isMethod('POST') and request::getInstance()->isAjaxRequest()) {
        ...
        reportePartoTableClass::delete($ids, FALSE);
        $this->arrayAjax = array(
            'code' => 200,
            'msg' => 'la eliminacion del registro fue exitosa'
        );
        $this->defineView('delete', 'reporte_parto', session::getInstance()->getFormatOutput());
       bitacora::register('ELIMINAR', reportePartoBaseTableClass::getNameTable());
        ...
        routing::getInstance()->redirect('reporte_parto', 'delete');
      }
